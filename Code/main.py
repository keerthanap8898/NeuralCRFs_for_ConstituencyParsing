...
if __name__ == "__main__":
    ...
    y=train(model, traindata, devdata, optimizer)
   
    print (y)
    # initializing the data
 
    x = list(i+1 for i in range (len(y)))
    ...
    for i, tree in enumerate(ground_truth):
        ...
        if tree.sen_len() <=10:
            ...
            draw_tree(tree, res_path =f"./images/ground_truth_{i}.png")
            draw_tree(from_string(predictions[i]), res_path=f"./images/pred_{i}.png")
            print_tree_count-=1
